...
\begin{figure}[h!]\centering
\includegraphics[width=4cm]{qu1.png}
...
\begin{figure}[h!]\centering
\includegraphics[width=4cm]{qu2.png}
...
\begin{figure}[h!]\centering
\includegraphics[width=16cm]{comparaison.png}
...
\begin{figure}[h!]\centering
\includegraphics[width=4cm]{rem.png}
...
\begin{figure}[h!]\centering
\subfloat[$C=1$]{\includegraphics[width=6cm]{GUI1.png}}
\subfloat[$C=0.01$]{\includegraphics[width=6cm]{GUI2.png}}
\subfloat[$C=0.001$]{\includegraphics[width=6cm]{GUI3.png}}\\
\subfloat[$C=0.0005$]{\includegraphics[width=6cm]{GUI4.png}}
\subfloat[$C=0.0001$]{\includegraphics[width=6cm]{GUI5.png}}
...
\begin{figure}[h!]\centering
\includegraphics[width=10cm]{erreur.png}
...
\begin{figure}[h!]\centering
\includegraphics[width=15cm]{blair.png}
...
\begin{figure}[h!]\centering
\includegraphics[width=5cm]{pixel.png}
